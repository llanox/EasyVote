...
/**
 * A fragment representing a single QuestionModel detail screen. This fragment is
 * either contained in a com.llanox.mobile.easyvote.activities.QuestionListActivity in two-pane mode (on
 * tablets) or a {@link com.llanox.mobile.easyvote.activities.QuestionDetailActivity} on handsets.
 */
public class QuestionDetailFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		String idItem = getArguments().getString(ARG_ITEM_ID);
		StoreSession<QuestionModel> data = new QuestionStore(getActivity());
