...
import com.llanox.mobile.easyvote.fragments.QuestionDetailFragment;
import com.llanox.mobile.easyvote.fragments.QuestionListFragment;
 ...
 * {@link com.llanox.mobile.easyvote.fragments.QuestionListFragment} and the item details (if present) is a
 * {@link com.llanox.mobile.easyvote.fragments.QuestionDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link com.llanox.mobile.easyvote.fragments.QuestionListFragment.Callbacks} interface to listen for item
 * selections.
 */
public class QuestionListActivity extends Activity implements
	...
	private void openNewQuestion() {
		Intent detailIntent = null;
		detailIntent = new Intent(this, AskQuestionActivity.class);
		startActivity(detailIntent);
		this.finish();
	}
}
